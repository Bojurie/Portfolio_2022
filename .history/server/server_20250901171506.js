...
// import mongoSanitize from "express-mongo-sanitize"; // ❌ remove
import xss from "xss-clean";
import mongoose from "mongoose";

import { sanitizeInputs } from "./middleware/sanitize.js"; // ✅ add
...
// app.options(/.*/, cors(corsOptions)); // (optional) preflight handler
...
// 🔒 Express 5–safe sanitization (in place; no reassigning req.query)
app.use(sanitizeInputs("_"));
