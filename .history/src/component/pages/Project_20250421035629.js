...
const projects = [
  { img: img1, video: video2, title: "E-Commerce UI" },
  { img: img2, video: video8, title: "Portfolio Website" },
  { img: img3, video: video6, title: "Admin Dashboard" },
  { img: img4, video: video0, title: "News Platform" },
  { img: img5, video: video4, title: "Social App" },
  { img: img6, video: video5, title: "Booking System" },
  { img: img7, video: video3, title: "Analytics Tool" },
  { img: img8, video: video7, title: "Job Board" },
  { img: img9, video: video1, title: "Product Preview" },
];
