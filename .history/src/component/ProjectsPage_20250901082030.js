...
const ProjectsPage = () => {
  ...
  // Wrapper used by <ProjectFilter /> and to close the mobile filter sheet
  ...
  const handleOpenModal = useCallback((index) => {
    // Hook up your modal here (or route-based modal)
  ...
  const handleVideoPlay = useCallback(
    (index, e) => {
      e?.stopPropagation();
      // Optional: video play logic for the listing page
