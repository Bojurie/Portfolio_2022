...
const ProjectModal = memo(
  ({
    ...
    const hasVideo =
      currentProject?.videoSources && currentProject.videoSources.length > 0;
                      ...
                      <div className="modal-project-media">
                        {hasVideo && !hasVideoError[index] ? (
                          <>
                            ...
                            >
                              {project.videoSources.map((source, i) => (
                                <source
                                  key={i}
                                  src={source.src}
                                  type={source.type}
                            ...
                            {isIOSDevice && playingVideo !== index && (
                              ...
                              >
                                <img
                                  src={project.poster || project.img}
                                  alt={project.title}
                                  onError={(e) => {
