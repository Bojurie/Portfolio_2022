...
// small helpers for local user cache
const saveUser = (u) => {
  try {
...
export const AuthProvider = ({ children }) => {
  ...
  /**
   * GET /auth/me — reads user from httpOnly cookie
   */
  ...
  /**
   * POST /auth/login — server sets cookie; returns { user }
   */
  ...
  /**
   * POST /auth/register — simple flow (optional autoLogin)
   */
